      ...
      {tides.map((tide, index) => {
        ...
        return (
          ...
          >
            ...
            <div
              className={`text-lg font-bold mb-1 ${tide.type === "HIGH" ? "text-blue-200" : "text-blue-100"}`}
            >
            ...
            {isNext && (
              <span className="text-xs text-yellow-500 mt-1 uppercase tracking-wider font-bold">
                Próxima
              </span>
            )}
          </div>
